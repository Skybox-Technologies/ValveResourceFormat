...
#pragma warning disable CS0168 // Variable is declared but never used
        ...
        public static void DebugValidateGLTF()
        {
            try
            {
            ...
            Nullable<JsonContent> extras = null)
        {
            ...
            var physNode = GltfPhysicsExporter.AddModelPhys(exportedModel, parentNode ?? scene, name,
        ...
        public static Accessor CreateAccessor(ModelRoot exportedModel, Vector2[] vectors)
        {
        ...
        public static Accessor CreateAccessor(ModelRoot exportedModel, Vector3[] vectors)
        {
